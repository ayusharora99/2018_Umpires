# 6/18/18 : Giants vs __OPPONENT__ : Manny Gonzalez

# 133 pitches were called strikes/balls

# The robot-ump called 35 of those pitches as called strikes & 98 as balls

# Manny Gonzalez called 47 of those pitches as called strikes & 86 as balls 

# Accuracy: 89%

Manny_Gonzalez <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Manny_Gonzalez_6:18:18.csv")
