# 4/23/18 : Giants vs __OPPONENT__ : Bill_Miller

# 151 pitches were called strikes/balls

# The robot-ump called 39 of those pitches as called strikes & 112 as balls

# Bill_Miller called 54 of those pitches as called strikes & 97 as balls 

# Accuracy: 89% 

Bill_Miller <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Bill_Miller_4:23:18.csv")
