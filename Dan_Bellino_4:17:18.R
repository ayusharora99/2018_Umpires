# 4/17/18 : Giants vs __OPPONENT__ : __UMPIRE__

# 112 pitches were called strikes/balls

# The robot-ump called 33 of those pitches as called strikes & 79 as balls

# __UMPIRE__ called 43 of those pitches as called strikes & 69 as balls 

# Accuracy: 88% 

Dan_Bellino <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Dan_Bellino_4:17:18.csv")
