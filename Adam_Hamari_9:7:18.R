# 9/7/18 : Giants vs Brewers : Adam Hamari

# 145 pitches were called strikes/balls

# The robot-ump called 33 of those pitches as called strikes & 112 as balls

# __UMPIRE__ called 51 of those pitches as called strikes & 94 as balls 

# Accuracy: 86%

Adam_Hamari <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Adam_Hamari_9:7:18.csv")
