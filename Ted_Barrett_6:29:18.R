# 6/29/18 : Giants vs __OPPONENT__ : Ted Barrett

# 143 pitches were called strikes/balls

# The robot-ump called 36 of those pitches as called strikes & 107 as balls

# Ted Barrett called 50 of those pitches as called strikes & 93 as balls 

# Accuracy: 90%

Ted_Barrett <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Ted_Barrett_6:29:18.csv")
