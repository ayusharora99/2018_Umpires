# 6/13/18: Giants vs __OPPONENT__ : John Tumpane

# 159 pitches were called strikes/balls

# The robot-ump called 43 of those pitches as called strikes & 116 as balls

# John Tumpane called 49 of those pitches as called strikes & 110 as balls 

# Accuracy: 94%

John_Tumpane <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/John_Tumpane_6:13:18.csv")
