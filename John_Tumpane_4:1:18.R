# 4/1/18 : Giants vs __OPPONENT__ : John Tumpane

# 129 pitches were called strikes/balls

# The robot-ump called 40 of those pitches as called strikes & 89 as balls

# __UMPIRE__ called 46 of those pitches as called strikes & 83 as balls 

# Accuracy: 95% 

John_Tumpane <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/John_Tumpane_4:1:18.csv")
