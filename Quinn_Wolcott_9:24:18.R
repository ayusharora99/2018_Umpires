# 9/24/18 : Giants vs Padres : Quinn Wolcott

# 124 pitches were called strikes/balls

# The robot-ump called 31 of those pitches as called strikes & 93 as balls

# Quinn Wolcott called 40 of those pitches as called strikes & 84 as balls 
...
Quinn_Wolcott <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Quinn_Wolcott_9:24:18.csv")
...
Quinn_Wolcott_AdjustedCalls$OnFieldRuling = ifelse(Quinn_Wolcott_AdjustedCalls$type == "S","S","B")
...
# Correct Calls
Quinn_Wolcott_AdjustedCalls$Call = ifelse( ((Quinn_Wolcott_AdjustedCalls$type == 'B') & ( (Quinn_Wolcott_AdjustedCalls$AdjustedCall == "B") | (Quinn_Wolcott_AdjustedCalls$Borderline == "T") ) ), "C","I" )
Quinn_Wolcott_AdjustedCalls$Call = ifelse( ((Quinn_Wolcott_AdjustedCalls$type == 'S') & ((Quinn_Wolcott_AdjustedCalls$AdjustedCall == "S") | (Quinn_Wolcott_AdjustedCalls$Borderline == "T") ) ), "C","I")

# InCorrect Calls
Quinn_Wolcott_AdjustedCalls$Call = ifelse( ( (Quinn_Wolcott_AdjustedCalls$type == 'B') & ((Quinn_Wolcott_AdjustedCalls$AdjustedCall == "S") & (Quinn_Wolcott_AdjustedCalls$Borderline == "F") ) ), "I","C")
Quinn_Wolcott_AdjustedCalls$Call = ifelse( ( (Quinn_Wolcott_AdjustedCalls$type == 'S') & ((Quinn_Wolcott_AdjustedCalls$AdjustedCall == "B") & (Quinn_Wolcott_AdjustedCalls$Borderline == "F") ) ), "I","C")

table(Quinn_Wolcott_AdjustedCalls$Call)

# Which Pitchers Recieved the InCorrect Calls
Quinn_Wolcott_Incorrect = subset(Quinn_Wolcott_AdjustedCalls, Quinn_Wolcott_AdjustedCalls$Call == "I")
print(Quinn_Wolcott_Incorrect$player_name)
print(Quinn_Wolcott_Incorrect$AdjustedCall)
