#5/2/18: Giants vs Padrs : Chris Guccione

#172 pitches were called strikes/balls

#The robot-ump called 43 of those pitches as called strikes & 129 as balls

#Chris Guccione called 46 of those pitches as called strikes & 126 as balls 

#Accuracy: 94%


Chris_Guccione <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Chris_Guccione_5:2:18.csv")
...
# Chris_Guccione Strike Zone: 93.6% Accurate, 97% Precision, 95% Recall
