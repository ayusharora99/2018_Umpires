...
# 9/10/18: Giants vs Braves : Mark_Wegner

# 122 pitches were called strikes/balls

# The robot-ump called 31 of those pitches as called strikes & 91 as balls

# Mark_Wegner called 31 of those pitches as called strikes & 91 as balls 
...
Mark_Wegner <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Mark_Wegner_9:10:18.csv")
