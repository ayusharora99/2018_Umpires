# 6/9/18 : Giants vs __OPPONENT__ : Scott Barry

# 168 pitches were called strikes/balls

# The robot-ump called 40 of those pitches as called strikes & 128 as balls

# Scott Barry called 49 of those pitches as called strikes & 119 as balls 

# Accuracy: 91%

Scott_Barry <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Scott_Barry_6:9:18.csv")
