Opening_Day_to_9_11_2018 <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Opening_Day_to_9_11_2018.csv")

Mark_Wegner <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Mark_Wegner_3:29:18.csv")
...
#Prediction_2018 = predict(tree_model, newdata = Opening_Day_to_9_11_2018, type = 'class')
#confusionMatrix(table(Prediction_2018,Opening_Day_to_9_11_2018$AdjustedCall))
