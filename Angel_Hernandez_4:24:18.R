# 4/24/18 : Giants vs __OPPONENT__ : Angel Hernandez

# 124 pitches were called strikes/balls

# The robot-ump called 32 of those pitches as called strikes & 92 as balls

# Angel Hernandez called 43 of those pitches as called strikes & 81 as balls 

# Accuracy: 90% 

Angel_Hernandez <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Angel_Hernandez_4:24:18.csv")
