# 6/8/18 : Giants vs __OPPONENT__ : Kerwin Danley

# 143 pitches were called strikes/balls

# The robot-ump called 43 of those pitches as called strikes & 100 as balls

# Kerwin Danley called 47 of those pitches as called strikes & 96 as balls 

# Accuracy: 89%

Kerwin_Danley <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Kerwin_Danley_6:8:18.csv")
