# 6/15/18 : Giants vs __OPPONENT__ : Phil Cuzzi

# 144 pitches were called strikes/balls

# The robot-ump called 34 of those pitches as called strikes & 110 as balls

# __UMPIRE__ called 41 of those pitches as called strikes & 103 as balls 

# Accuracy: 92%

Phil_Cuzzi <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Phil_Cuzzi_6:15:18.csv")
