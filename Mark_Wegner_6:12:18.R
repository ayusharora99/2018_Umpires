# 6/12/18 : Giants vs __OPPONENT__ : Mark Wegner

# 122 pitches were called strikes/balls

# The robot-ump called 38 of those pitches as called strikes & 84 as balls

# Mark Wegner called 39 of those pitches as called strikes & 83 as balls 

# Accuracy: 93%

Mark_Wegner <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Mark_Wegner_6:12:18.csv")
