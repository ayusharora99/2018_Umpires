# 4/30/18 : Giants vs __OPPONENT__ : Larry Vanover

# 134 pitches were called strikes/balls

# The robot-ump called 45 of those pitches as called strikes & 89 as balls

# Larry Vanover called 49 of those pitches as called strikes & 85 as balls 

# Accuracy: 93% 

Larry_Vanover <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Larry_Vanover_4:30:18.csv")
