# 3/31/18 : Giants vs Dodgers : Mike DiMuro

# 129 pitches were called strikes/balls

# The robot-ump called 36 of those pitches as called strikes & 93 as balls

# Mike DiMuro called 41 of those pitches as called strikes & 88 as balls 

# Accuracy: 90%

Mike_DiMuro <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Mike_DiMuro_3:31:18.csv")
