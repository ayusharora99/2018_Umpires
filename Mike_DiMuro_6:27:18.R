# 6/27/18 : Giants vs __OPPONENT__ : Mike DiMuro

# 125 pitches were called strikes/balls

# The robot-ump called 39 of those pitches as called strikes & 86 as balls

# Mike DiMuro called 41 of those pitches as called strikes & 84 as balls 

# Accuracy: 93%


Mike_DiMuro <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Mike_DiMuro_6:27:18.csv")
