#9/4/18: Giants vs Rockies : Ben May

#139 pitches were called strikes/balls

#The robot-ump called 45 of those pitches as called strikes & 94 as balls

#Ben May called 49 of those pitches as called strikes & 90 as balls 

#Accuracy: 93%

Ben_May <- read.csv("~/Desktop/Analyzing Baseball Data with R/2018 Giants Umpires/Ben_May_9:4:18.csv")
